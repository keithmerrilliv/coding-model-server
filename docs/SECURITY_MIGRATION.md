...
- **Mac dev machine** — `/Users/youruser/Dev/coding-model-server` (you run the client here).
...
cd /Users/youruser/Dev/coding-model-server && venv/bin/pip install -e . --no-deps
```
...
mv /Users/youruser/Dev/coding-model-server/.env ~/.config/coding-model-server/.env
...
cp /Users/youruser/Dev/coding-model-server/mac_runner/env.example         ~/.config/coding-model-runner/.env
cp /Users/youruser/Dev/coding-model-server/mac_runner/repos.example.yml   ~/.config/coding-model-runner/repos.yml
...
cd /Users/youruser/Dev/coding-model-server && venv/bin/pip install -e .
...
> `ProgramArguments` point at `/Users/youruser/Dev/coding-model-server` — LaunchAgent plists
