...
from coding_model_client.config import config, COLORS, PROMPT_COLORS, HISTORY_CHAR_BUDGET, print_colored
...
def handle_user_command(user_input, history, model, agent_theme):
    ...
    if user_input.lower() == '/help':
        ...
        print(f"                         (Claude + Gemini + Coding Model reviewer + deep_reviewer)")
