...
State lives in var/tasks_db/tasks.sqlite via coding_model_autonomous.Database. The
orchestrator daemon (coding-model-orchestrator.service) reads/writes the same database
