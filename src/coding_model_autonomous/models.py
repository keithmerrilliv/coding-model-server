...
EVENT_PAYLOAD_SCHEMAS: dict = {
    EventKind.FAILURE_CLASSIFIED: {
        ...
        "optional": {
            ...
            "reasoning_only": "empty_completion: the model spent its budget thinking — a reasoning-only 502 (DEV-760)",
    ...
    EventKind.ATTEMPT_PLANNED: {
        "required": {
            ...
            "assignment": "recommended | rotation | random | injected | fixed | sole_fit | rerouted — how the agent was chosen (DEV-530; sole_fit and rerouted are DEV-676)",
            "planned_agent": "on a rerouted record, the agent the rotation had planned before the fit check moved the dispatch; null otherwise (DEV-676)",
