...
router registration. The actual endpoints live in qwen_server.routes.*; shared
singletons and lifespan-managed services live in qwen_server.runtime.
"""
import logging
import os
import re
...
from qwen_server.logging_filters import (
...
from qwen_server.routes import admin, autonomous, chat, meta, memory
